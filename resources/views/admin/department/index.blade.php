                                                    ...
                                                    @if(count($Department) > 0)
                                                        @foreach($Department as $Departments)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="{{ url('/')}}/admin/departments/edit/{{ $Departments->id }}" class="btn btn-indigo btn-sm">
                                                                        <i class="fa fa-pencil mr-1"></i>
                                                                        Edit
                                                                    </a>
 
                                                                    <a href="{{ url('/')}}/admin/departments/destroy/{{ $Departments->id }} " class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this user?');">
