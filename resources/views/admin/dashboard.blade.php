							...
							<div class="col-sm-12 col-md-6 col-lg-6 col-xl-3">
								<div class="card">
									<div class="card-body text-center feature">
										...
										<p class="card-text mt-3 mb-3">Total Post</p>
							...
							<div class="col-sm-12 col-md-6 col-lg-6 col-xl-3">
								<div class="card">
									<div class="card-body text-center feature ">
										...
										<p class="card-text mt-3 mb-3">Fetured Post</p>
							...
							<div class="col-sm-12 col-md-6 col-lg-6 col-xl-3">
								<div class="card">
									<div class="card-body text-center feature">
										...
										<p class="card-text mt-3 mb-3">Feedback & Compaints</p>

										<p class="h2 text-center text-secondary-1 counter">22</p>
									</div>
								</div>
							</div><!-- COL END -->
						</div>
